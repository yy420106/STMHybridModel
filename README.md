...
# Fig. 5b-c and Extended Data Fig. 8a-h
...
```
**Note:** If you want to explore the **alternative model** (Extended Data Fig. 10a-d), in which the cycle-related parameters are excluded, please turn to function `_calc_beta` (**line 81-108**) in `util_funcs.py`, and **swap the comment state between line 105 and 106** before running the scripts.
